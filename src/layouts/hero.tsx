...
const SectionMenuItem = ({section}:SectionMenuItemProps) => <div className='bg-gray-200 m-4 rounded shadow h-16'>
            ...
            <div className='h-full'>
                ...
                <div className='w-full tablet:flex'>
                    ...
                    <div className='w-full tablet:w-2/5'>
                        { this.props.sections.map( (section) => <SectionMenuItem section={section}></SectionMenuItem>)}
                    </div>
                </div>
